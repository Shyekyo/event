...
object CaseClass extends Serializable{
  case class ACCOUNT_TYPE(ACCOUNT_TYPE_ID:Int,ACCOUNT_TYPE_NAME:String,ACCOUNT_REF_PREFIX:String,ACCT_TYPE:String) extends Serializable
    ...
    case class ACCT_ITEM(ACCT_ITEM_ID:Int,ITEM_SOURCE_ID:String/**数字可以为空*/,CUST_ID:Int,STATE:Int
                       ,ACCT_ITEM_TYPE_ID:Int,BILLING_CYCLE_ID:Int,CREATE_DATE:Int,
                       PAYMENT_METHOD:String/**数字可以为空*/,REF_NO:String,GEN_FLAG:Int,GEN_ID:Int,
                       COMMENTS:String,PAY_TYPE:String,DEP_ABBR:String,FLAG:Int,SETTLE_DATE:String/**数字可以为空*/,
                       TYPE_ID:String/**数字可以为空*/,BUREAU_ID:Int,APPROVE_FLAG:Int) extends Serializable
  ...
  case class AMOUNT(AMOUNT_ID:Int,ACCOUNT_ITEM_ID:String,STATE:Int,AMOUNT:Double,CURRENCY:String,COMMENTS:String) extends Serializable
  ...
  case class STT_OBJECT(CUST_ID:Int,CUST_NAME:String,CUST_TYPE_ID:Integer,CUST_LOCATION:String/**数字可以为空*/,
                        IS_VIP:Int,PARENT_ID:String/**数字可以为空*/,CUST_CODE:String,STATE:String,EFF_DATE:String,EXP_DATE:String,
                        COUNTRY_ID:Int,SCALE:String,MODIFIER:String,UPDATE_TIME:String,TSP_ID:String/**数字可以为空*/) extends Serializable
